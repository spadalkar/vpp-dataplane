...
type CapoRule struct {
	...
	IsL4Proto     bool                   `binapi:"bool,name=is_l4_proto" json:"is_l4_proto,omitempty"`
	IsNotL4Proto  bool                   `binapi:"bool,name=is_not_l4_proto" json:"is_not_l4_proto,omitempty"`
	L4Proto       uint8                  `binapi:"u8,name=l4_proto" json:"l4_proto,omitempty"`
	IsICMPType    bool                   `binapi:"bool,name=is_icmp_type" json:"is_icmp_type,omitempty"`
	IsNotICMPType bool                   `binapi:"bool,name=is_not_icmp_type" json:"is_not_icmp_type,omitempty"`
	ICMPType      uint8                  `binapi:"u8,name=icmp_type" json:"icmp_type,omitempty"`
	IsICMPCode    bool                   `binapi:"bool,name=is_icmp_code" json:"is_icmp_code,omitempty"`
	IsNotICMPCode bool                   `binapi:"bool,name=is_not_icmp_code" json:"is_not_icmp_code,omitempty"`
	ICMPCode      uint8                  `binapi:"u8,name=icmp_code" json:"icmp_code,omitempty"`
...
// CapoSetID defines type 'capo_set_id'.
type CapoSetID struct {
...
func CapoEntryDataUnionSetID(a CapoSetID) (u CapoEntryDataUnion) {
	u.SetSetID(a)
	return
}
func (u *CapoEntryDataUnion) SetSetID(a CapoSetID) {
	buf := codec.NewBuffer(u.XXX_UnionData[:])
	buf.EncodeUint32(a.SetID)
}
func (u *CapoEntryDataUnion) GetSetID() (a CapoSetID) {
	buf := codec.NewBuffer(u.XXX_UnionData[:])
...
func (*CapoRuleCreate) GetCrcString() string   { return "4fc66b64" }
...
func (m *CapoRuleCreate) Size() (size int) {
	...
	size += 1 // m.Rule.Af
	size += 1 // m.Rule.IsL4Proto
	size += 1 // m.Rule.IsNotL4Proto
	size += 1 // m.Rule.L4Proto
	size += 1 // m.Rule.IsICMPType
	size += 1 // m.Rule.IsNotICMPType
	size += 1 // m.Rule.ICMPType
	size += 1 // m.Rule.IsICMPCode
	size += 1 // m.Rule.IsNotICMPCode
	size += 1 // m.Rule.ICMPCode
...
func (m *CapoRuleCreate) Marshal(b []byte) ([]byte, error) {
	...
	buf.EncodeBool(m.Rule.IsL4Proto)
	buf.EncodeBool(m.Rule.IsNotL4Proto)
	buf.EncodeUint8(m.Rule.L4Proto)
	buf.EncodeBool(m.Rule.IsICMPType)
	buf.EncodeBool(m.Rule.IsNotICMPType)
	buf.EncodeUint8(m.Rule.ICMPType)
	buf.EncodeBool(m.Rule.IsICMPCode)
	buf.EncodeBool(m.Rule.IsNotICMPCode)
	buf.EncodeUint8(m.Rule.ICMPCode)
...
func (m *CapoRuleCreate) Unmarshal(b []byte) error {
	...
	m.Rule.IsL4Proto = buf.DecodeBool()
	m.Rule.IsNotL4Proto = buf.DecodeBool()
	m.Rule.L4Proto = buf.DecodeUint8()
	m.Rule.IsICMPType = buf.DecodeBool()
	m.Rule.IsNotICMPType = buf.DecodeBool()
	m.Rule.ICMPType = buf.DecodeUint8()
	m.Rule.IsICMPCode = buf.DecodeBool()
	m.Rule.IsNotICMPCode = buf.DecodeBool()
	m.Rule.ICMPCode = buf.DecodeUint8()
...
func (*CapoRuleUpdate) GetCrcString() string   { return "5744f74e" }
...
func file_capo_binapi_init() {
	...
	api.RegisterMessage((*CapoRuleCreate)(nil), "capo_rule_create_4fc66b64")
	...
	api.RegisterMessage((*CapoRuleUpdate)(nil), "capo_rule_update_5744f74e")
